  ...
  function VideoRecorder() {
    ...
    _defineProperty(_assertThisInitialized(_this), 'turnOnCamera', function () {
      ...
      navigator.mediaDevices
        .getUserMedia(_this.props.constraints)
        ['catch'](function (err) {
    ...
    _defineProperty(
      ...
      function (rawVideoBlob) {
        return rawVideoBlob.arrayBuffer().then(function (buffer) {
          ...
          var seekableMetadata = _tsEbml.tools.makeMetadataSeekable(
            reader.metadatas,
            reader.duration,
            reader.cues
          )
    ...
    _defineProperty(
      _assertThisInitialized(_this),
      'handleStopReplaying',
      function (onStopReplayingParam) {
        if (_this.props.onStopReplaying) {
          _this.props.onStopReplaying(onStopReplayingParam)
        }
    ...
    _defineProperty(
      ...
      'handleDownload',
      function () {
        if (_this.props.getDownloadFilename) {
          var videoBlob = _this.state.fixedVideoBlob

          var downloadFilename = _this.props.getDownloadFilename()

          ;(0, _fileSaver.saveAs)(videoBlob, downloadFilename)
        }
      }
    )
    ...
    },
    {
      ...
      value: function render() {
        ...
        var _this$props3 = this.props,
          ...
          showDownloadButton = _this$props3.showDownloadButton,
          replayVideoAutoplayAndLoopOff =
...
_defineProperty(VideoRecorder, 'propTypes', {
  ...
  getDownloadFilename: _propTypes['default'].func,
